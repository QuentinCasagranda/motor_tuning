...
Go in the inputs of your axis, in *FromPLC > ControlDword* and link link the two FeedEnable inputs to your limit switch inputs. 
...
To create a YT chart, open a new twinCAT project and select a visualization project.

.. figure:: img/yt_chart.png
   :width: 600
   :align: center

   Creating a YT chart project

Then in the datapool of your project go to the NC-Task, select your motor's axis and add the following variables to your data pool :
- Actual Velocity
- Set Velocity
- Actual Position
- Set Position 
...
.. figure:: img/yt_chart_datapool.png
   :width: 600
   :align: center
...
Send three to four velocity step sequances of 4 cycle with a velocity starting from the nominal velocity of your motor and divide it by ten for each sequence.
...
For the position precision caracterization, you can use the Reversing Sequence function. It will send a position command to your motor, then a command to go back to the initial position, and repeat this cycle.

.. figure:: img/reversing_seq.png
   :width: 700
   :align: center
